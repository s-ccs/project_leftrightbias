...
@fig:results shows the spatial bias for each of the six arrangements of stimulus pairs and reactions times for all 12 positions. Participants predominantly made their first fixation on images located to the left of the fixation, consistent with the left bias described in the literature. In the typical 3/9 o'clock horizontal presentation condition, we observed on average 80% left-first fixations ($"CI"_95: [68-90]%$). We further find a similar sized top bias (81%,$"CI"_95:[70-91]%$). Only when the stimuli were presented in the 1/7 o'clock position, we observed no bias (50%,$"CI"_95:[38-62]%$)).
